...
app.include_router(prod_launch.router)
app.include_router(mrr_30k.router)
app.include_router(mrr_100k.router)
app.include_router(enterprise.router)
app.include_router(mrr_1m.router)
app.include_router(beta_zero.router)
...
app.include_router(search_augmented.router)
app.include_router(eval_auto.router)
